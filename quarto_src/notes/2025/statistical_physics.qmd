...
Throughout the note we reference the statistical setting of flipping independent, biased coins, each with probability $p$ of landing heads. As discussed in this [note](../2025/statistical_inference.html), the likelihood of observing a sequence $\boldsymbol{s}$ with $n_H$ heads out of $n$ flips is
...
We define an physical model equivalent to this statistical one and  explore how a perspective motivates alternative types of models and inference techniques. The presentation here is adapted from my PhD thesis, alongside reviews of [statistical inference](../2025/statistical_inference.html) and [information theory](../2025/information_theory.html)   
