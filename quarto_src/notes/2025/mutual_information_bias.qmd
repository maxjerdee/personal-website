...
image: ../../assets/images/notes/mutual_information_bias/thumbnail.svg
# include-in-header:
...
![How similar are these two clusterings of the same set of objects? In these examples the solid boundaries denote the groups of objects, and the colors indicate the true underlying groups. By our measure, the prediction contains about 60% of the true information.]({{< meta assets-folder >}}/thumbnail.svg){width=3in} 
...
By ensuring that the yardstick by which much of science progresses is not skewed or biased, we improve the rigor and reliability of findings across many applications. 

Check out [our paper](https://arxiv.org/abs/2307.01282) for the full details, and our implementation of the measure [here](https://github.com/maxjerdee/clustering-mi).
