...
image: ../../assets/images/notes/information_theory/coin-flip-perspectives.pdf
format:
  pdf:
    include-in-header:
...
sense, underpinning much of my research. The review is adapted from my PhD thesis.
...
Figure [1](#fig:coin-flip-perspectives).  

![Encoding coin flips as a binary string]({{< meta assets-folder >}}/coin-flip-perspectives.pdf){#fig:coin-flip-perspectives}
...
Figure [2](#fig:encoding-examples){reference-type="ref"
...
strings.]({{< meta assets-folder >}}/encoding-examples.pdf){#fig:encoding-examples}
...
to a particular data set, although for our purposes we consider
