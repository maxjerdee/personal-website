...
We also note that among all possible distributions $\{p_r\}$ on $q$
...
across realistic data sets are as small as possible.
...
By interpreting models as encodings of data we can motivate many of the
