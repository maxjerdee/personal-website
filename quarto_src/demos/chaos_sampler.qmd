...
<div id="chaosContainer" style="display: flex; justify-content: space-between;">
    <img id="chaos" width=400 src="../assets/images/lorentz_explainer.png" style="width: 55%;">
    <img id="trajectory" width=400 src="../assets/images/lorentz_trajectory.png" style="width: 40%;">
</div>
<div id="recordContainer">
    <img id="record" src="../assets/images/amen-record.png" alt="Record">
</div>
